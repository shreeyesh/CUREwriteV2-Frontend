...
const HOMEPAGERESEARCHBUYNOW1 = () => {
  const navigation = useNavigation();

  return (
    <View style={styles.homepageResearchBuyNow}>
      <View style={[styles.groupParent, styles.parentLayout]}>
        <View style={[styles.groupContainer, styles.image13ParentLayout]}>
          <ProductBuyCTA
            productName="Oncology -Preventive Ways"
            productAuthor="Dr. Petersen | 2010"
            group878MarginLeft={-123.5}
            group878Width={252}
            studyOfOralHealthMarginLeft={-126}
            studyOfOralHealthWidth={252}
            rateThisPaperMarginLeft={-41}
            starRatingMarginLeft={-57}
            ganresMarginLeft={-50}
      ...
      <View style={styles.ellipseParent}>
        ...
        <View style={[styles.rectangleParent, styles.rectangleLayout]}>
          ...
          <BottomTabs
            ...
            icon1={require("../assets/group-8302.png")}
          />
        </View>
      </View>
      <BackButton
...
export default HOMEPAGERESEARCHBUYNOW1;
