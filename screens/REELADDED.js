...
const REELADDED = () => {
  ...
  return (
    <View style={styles.reelAdded}>
      <View style={[styles.reelAddedChild, styles.reelPosition]} />
      <Text style={styles.reelAdded1}>Reel Added</Text>
      <ContinueButton
      ...
      />
      <Image
        style={[styles.reelAddedItem, styles.reelPosition]}
        resizeMode="cover"
